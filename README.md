<div align="center">
<img alt="Electron Gridsome Crossover Banner" src="https://raw.githubusercontent.com/soulehshaikh99/assets/master/create-electron-framework-app/readme/svg/Electron_Gridsome.svg" width="580" />
</div>
<br />
The boilerplate code to get started creating Cross-platform Desktop Apps with Electron and Gridsome as front-end technology.
<br />
<br />
<div align="center">
...
The aim of this project is to provide Web Developers using `gridsome` the power to create cross-platform desktop apps using `electron`.
...
**`gridsome`** makes it easy for developers to build static generated websites & apps that are fast by default. Gridsome generates static PWAs. Only critical HTML, CSS, and JavaScript get loaded first. The next pages are then prefetched so users can click around incredibly fast without page reloads, even when offline. Gridsome sites load as static HTML before they hydrate into fully Vue.js-powered SPAs. This makes it possible for search engines to be able to crawl content and give better SEO ranking, and still have all the power of Vue.js. The future of the web is JavaScript, APIs, and Markup - the Jamstack. Gridsome uses the power of blazing fast static site generation, JavaScript and APIs to create stunning modern web experiences.
...
$ npx degit soulehshaikh99/create-gridsome-electron-app create-gridsome-electron-app
# or GitHub CLI Users
$ gh repo clone https://github.com/soulehshaikh99/create-gridsome-electron-app.git
# or Normal Git Users
$ git clone https://github.com/soulehshaikh99/create-gridsome-electron-app.git
